 ...
 * @returns {Number}
 */
export function calculateWantedLevelGain(gang, member, task) {
 ...
 * @returns {Number}
 */
export function calculateMoneyGain(gang, member, task) {
 ...
 * @returns {Number}
 */
export function calculateWantedPenalty(gang) {
